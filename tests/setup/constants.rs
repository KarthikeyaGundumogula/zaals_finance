...
pub const DISPUTE_WINDOW: i64 = 2 * ONE_DAY;
pub const EARLY_UNLOCK_FEE: u64 = 2_000;
pub const MAX_LOCK_DURATION: i64 = 365 * ONE_DAY;
pub const MIN_LOCK_DURATION: i64 = 31 * ONE_DAY;
pub const INVESTOR_BPS: u16 = 5_000;
pub const BASE_BPS: u16 = 10_000;
pub const MIN_LOCK_AMOUNT: u64 = 1 * LAMPORTS_PER_SOL;
pub const MIN_VAULT_TARGET: u64 = 20 * LAMPORTS_PER_SOL;

// POSITION data
pub const DEPOSIT_AMOUNT: u64 = MIN_LOCK_AMOUNT + 5 * LAMPORTS_PER_SOL;
pub const REWARDS_DEPOSIT: u64 = 100 * LAMPORTS_PER_SOL;
pub const SLASH_BPS: u16 = 15_00;

pub const TRANSFER_AMOUNT: u64 = 100 * LAMPORTS_PER_SOL;
pub const DECIMALS: u8 = 9;
pub const SALE_PRICE: u64 = 10 * LAMPORTS_PER_SOL;
