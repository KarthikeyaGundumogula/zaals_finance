...
impl CreateVaultHandler {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateVaultHandlerInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl CreateVaultHandlerBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = CreateVaultHandler {
            ...
            nft_marketplace: self.nft_marketplace.unwrap_or(solana_pubkey::pubkey!(
        ...
        let args = CreateVaultHandlerInstructionArgs {
            ...
            min_lock_amount: self
                .min_lock_amount
                .clone()
                .expect("min_lock_amount is not set"),
            beneficiaries: self
                .beneficiaries
                .clone()
                .expect("beneficiaries is not set"),
            investor_bps: self.investor_bps.clone().expect("investor_bps is not set"),
            max_slash_bps: self
                .max_slash_bps
                .clone()
                .expect("max_slash_bps is not set"),
            lock_phase_duration: self
                .lock_phase_duration
                .clone()
                .expect("lock_phase_duration is not set"),
            lock_phase_start_time: self
                .lock_phase_start_time
                .clone()
                .expect("lock_phase_start_time is not set"),
        };
...
impl<'a, 'b> CreateVaultHandlerCpiBuilder<'a, 'b> {
    ...
    /// The vault provider/creator who pays for account initialization
    #[inline(always)]
    pub fn node_operator(
        &mut self,
        node_operator: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn nft_collection(
        &mut self,
        nft_collection: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    #[inline(always)]
    pub fn nft_marketplace(
        &mut self,
        nft_marketplace: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let args = CreateVaultHandlerInstructionArgs {
            min_cap: self
                ...
                .min_cap
                .clone()
                .expect("min_cap is not set"),
            max_cap: self
                .instruction
                .max_cap
                .clone()
                .expect("max_cap is not set"),
            min_lock_amount: self
                .instruction
                .min_lock_amount
                .clone()
            ...
            investor_bps: self
                ...
                .investor_bps
                .clone()
                .expect("investor_bps is not set"),
            max_slash_bps: self
                .instruction
                .max_slash_bps
                .clone()
        ...
        let instruction = CreateVaultHandlerCpi {
            ...
            node_operator: self
                .instruction
                .node_operator
                .expect("node_operator is not set"),
            ...
            nft_collection: self
                .instruction
                .nft_collection
                .expect("nft_collection is not set"),
            ...
            nft_marketplace: self
                .instruction
                .nft_marketplace
                .expect("nft_marketplace is not set"),
