...
impl ClaimInvestorRewardsHandler {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        accounts.push(solana_instruction::AccountMeta::new(self.holder_ata, false));
        accounts.push(solana_instruction::AccountMeta::new_readonly(
            self.token_program,
            false,
        ));
        ...
        let data = ClaimInvestorRewardsHandlerInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl<'a, 'b> ClaimInvestorRewardsHandlerCpiBuilder<'a, 'b> {
    ...
    pub fn holder_ata(
        &mut self,
        holder_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
