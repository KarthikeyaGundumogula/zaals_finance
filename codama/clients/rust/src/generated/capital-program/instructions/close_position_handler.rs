...
impl ClosePositionHandler {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let data = ClosePositionHandlerInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl ClosePositionHandlerBuilder {
    ...
    #[inline(always)]
    pub fn capital_provider_lock_ata(
        &mut self,
        capital_provider_lock_ata: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = ClosePositionHandler {
            ...
            capital_provider_lock_ata: self
                .capital_provider_lock_ata
                .expect("capital_provider_lock_ata is not set"),
...
impl<'a, 'b> ClosePositionHandlerCpiBuilder<'a, 'b> {
    ...
    /// The capital provider who owns the position
    #[inline(always)]
    pub fn position_holder(
        &mut self,
        position_holder: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn capital_provider_lock_ata(
        &mut self,
        capital_provider_lock_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        let instruction = ClosePositionHandlerCpi {
            ...
            position_holder: self
                .instruction
                .position_holder
                .expect("position_holder is not set"),
