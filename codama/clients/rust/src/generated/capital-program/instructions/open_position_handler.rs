...
impl OpenPositionHandler {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = OpenPositionHandlerInstructionData::new()
            .try_to_vec()
            .unwrap();
...
impl OpenPositionHandlerBuilder {
    ...
    /// Capital provider's token account
    #[inline(always)]
    pub fn capital_provider_token_ata(
        &mut self,
        capital_provider_token_ata: solana_pubkey::Pubkey,
    ) -> &mut Self {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        let accounts = OpenPositionHandler {
            ...
            capital_provider_token_ata: self
                .capital_provider_token_ata
                .expect("capital_provider_token_ata is not set"),
            vault_ata: self.vault_ata.expect("vault_ata is not set"),
            locked_token_mint: self
                .locked_token_mint
                .expect("locked_token_mint is not set"),
...
impl<'a, 'b> OpenPositionHandlerCpiBuilder<'a, 'b> {
    ...
    /// The capital provider who is opening the position
    #[inline(always)]
    pub fn capital_provider(
        &mut self,
        capital_provider: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    /// The vault's NFT collection
    #[inline(always)]
    pub fn vault_collection(
        &mut self,
        vault_collection: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn nft_config(
        &mut self,
        nft_config: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn capital_provider_token_ata(
        &mut self,
        capital_provider_token_ata: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    /// The token mint for locked capital
    #[inline(always)]
    pub fn locked_token_mint(
        &mut self,
        locked_token_mint: &'b solana_account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = OpenPositionHandlerCpi {
            ...
            capital_provider: self
                .instruction
                .capital_provider
                .expect("capital_provider is not set"),

            asset: self.instruction.asset.expect("asset is not set"),

            vault_collection: self
                .instruction
                .vault_collection
                .expect("vault_collection is not set"),
